...
from utils import seg_depart, class_by_keyword_1342, class_by_keyword
...
class Eval:
    ...
    def calculate(self, prediction_list : List[str], ground_truth_list: List[str]):
        """
...
predicted_file = "/mnt/10.252.194.4/export/Data/xiaojie.guo/unilm_794/title_with_pretrain/bert_save_v4/model.32.bin.eval"
gt_file = path+"processed_title/processed/eval.tgt"
