...
def main():
    ...
    for model_recover_path in glob.glob(args.model_recover_path.strip()):
        ...
        model = BertForSeq2SeqDecoder.from_pretrained(args.bert_model, state_dict=model_recover, num_labels=cls_num_labels, num_rel=pair_num_relation, type_vocab_size=type_vocab_size, config_path=args.config_path, task_idx=3, mask_word_id=mask_word_id, search_beam_size=args.beam_size,
