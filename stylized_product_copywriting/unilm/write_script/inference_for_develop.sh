...
MODEL_RECOVER_PATH=/mnt/10.252.199.12/home/xiaojie.guo/Data/unilm_794/with_pretrain/bert_save_v4/model.100.bin
EVAL_SPLIT=eval
...
# run decoding
CUDA_VISIBLE_DEVICES='1,2,3,4' nohup  python ../decode_seq2seq.py >output_gen \
...
--max_seq_length 128 --max_tgt_length 90 \
