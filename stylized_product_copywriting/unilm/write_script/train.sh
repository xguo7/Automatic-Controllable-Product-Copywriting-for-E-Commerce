DATA_DIR=/mnt/10.252.199.12/home/xiaojie.guo/daren_data/794/processed_data/processed
OUTPUT_DIR=/home/xiaojie.guo/Data/unilm_794/with_pretrain
...
#
CUDA_VISIBLE_DEVICES='0,1,2,3' nohup python ../run_seq2seq.py --do_train --fp16 --amp \
--num_workers 0 \
--bert_model /home/xiaojie.guo/Data/unilm_pretrain/model_epoch74/ \
...
--train_batch_size 220 --gradient_accumulation_steps 2 \
