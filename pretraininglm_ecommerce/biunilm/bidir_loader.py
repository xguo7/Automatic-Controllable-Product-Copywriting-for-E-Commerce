...
class BiDirDataset(torch.utils.data.Dataset):
    """ Load sentence pair (sequential or random order) from corpus """

    def __init__(self, file_src, file_tgt, batch_size, tokenizer, max_len, file_nsp = None, file_oracle=None, short_sampling_prob=0.1, sent_reverse_order=False, bi_pipeline=[]):
        super().__init__()
...
class Preprocess4BiDirection(Pipeline):
